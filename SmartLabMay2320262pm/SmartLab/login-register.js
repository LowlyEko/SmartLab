...
document.getElementById('loginForm').addEventListener('submit', async (e) => {
  ...
  setLoading('login-btn', true, 'Login as administrator');
  ...
  try {
    ...
    setLoading('login-btn', false, 'Login as administrator');
  }
});
...
document.getElementById('registerForm').addEventListener('submit', async (e) => {
  ...
  const user_type  = document.getElementById('register-user-type') ? document.getElementById('register-user-type').value : 'laboratory_staff';
  ...
  try {
    const res  = await fetch(`${API_BASE}/auth/register`, {
      ...
      body: JSON.stringify({
        ...
        email,
        password,
        role: user_type || 'laboratory_staff',
      }),
    });
    const data = await res.json();
