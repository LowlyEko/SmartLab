...
function normaliseReservation(r) {
  ...
  const timeStart = r.time_start ? new Date(`1970-01-01T${r.time_start}`) : null;
  const timeEnd = r.time_end ? new Date(`1970-01-01T${r.time_end}`) : null;
  ...
  return {
    ...
    conditionsNote:  r.remarks || '',  // saved into DB remarks column when admin marks Conditional
