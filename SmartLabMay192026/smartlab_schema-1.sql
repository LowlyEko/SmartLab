...
CREATE TABLE `accountability` (
  ...
  `member_name` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `materials_broken` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `prof_name` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `subject` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `time_start` time DEFAULT NULL,
  `time_end` time DEFAULT NULL,
  `program_course_section` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `admin` (
  ...
  CONSTRAINT `admin_chk_1` CHECK ((`role` in (_utf8mb4'laboratory_staff',_utf8mb4'laboratory_chemist')))
...
INSERT INTO `admin` VALUES (1,'Lance','Libron','lancelibron09@gmail.com','$2y$10$7lUUIpWDQyZWqoOGczA62OyABOSsyLZY9IakbtjUxci1WaPNWeBGu','laboratory_staff',1,'2026-05-15 08:58:40','2026-05-16 05:04:36');
...
CREATE TABLE `inventory_apparatus` (
  ...
  `apparatus_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `inventory_equipment` (
  ...
  `calibration_frequency` enum('Annual','Semi-Annual','Monthly','As Needed') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('FUNCTIONAL','NOT FUNCTIONAL','FOR REPAIR','NEW') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'FUNCTIONAL',
  `remarks` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `inventory_glassware` (
  ...
  `glassware` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_id` bigint unsigned NOT NULL,
  `remarks` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quantity` int NOT NULL DEFAULT '0',
...
CREATE TABLE `inventory_supplies` (
  ...
  `supplies_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `brand` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_id` bigint unsigned NOT NULL,
  `quantity` int NOT NULL DEFAULT '0',
  `quantity_unit` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `reservation` (
  ...
  `prof_name` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `subject` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `date_reserved` date NOT NULL,
  `date_borrowed` date NOT NULL,
  `time_of_activity` time NOT NULL,
  `course_year_section` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `group_number` int DEFAULT NULL,
  `type` enum('chemicals','equipment') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `reservationequipment` (
  `id` int NOT NULL AUTO_INCREMENT,
  `reservation_id` int NOT NULL,
  `item_type` enum('equipment','apparatus','glassware','supplies') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `student` (
  ...
  `email` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `college` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `student` VALUES (2,NULL,'JAY','LUMANTA','jplumanta01549@usep.edu.ph',NULL,0,NULL,1,'2026-05-15 08:59:52','2026-05-16 05:03:07','student');
...
-- Dump completed on 2026-05-18  1:01:34
